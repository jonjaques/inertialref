/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e750c443505ea5722bcad434fffeb414)
...
interface __BaseEnv_Env {
	...
	TOUR_GUIDE_TRACE: "false";
	OPENAI_API_KEY: string;
	TOUR_GUIDE_PASSWORD: string;
	TOUR_SESSIONS: DurableObjectNamespace<import("./src/index").TourSession>;
	TOUR_ADMISSION: DurableObjectNamespace<import("./src/index").TourAdmission>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TourSession" | "TourAdmission";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TOUR_GUIDE_ENABLED" | "TOUR_GUIDE_TRACE" | "OPENAI_API_KEY" | "TOUR_GUIDE_PASSWORD">> {}
}
