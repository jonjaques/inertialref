...
import { PROFILE } from './paths.ts'

/**
 * Where an identity provider comes back to.
 *
 * A real page rather than a placeholder, because the two things it has to get
...
export function AuthCallbackPage() {
  ...
  const [state] = useState(() => {
    const params = new URLSearchParams(
      overlay === null ? '' : locationOf(overlay).search,
    )
    return {
