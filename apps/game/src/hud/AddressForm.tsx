  ...
  return (
    ...
    >
      <Input
        ...
        className="h-6 min-w-0 flex-1 rounded border-slate-700 bg-slate-900/80 px-1.5 py-0.5 font-mono text-[11px] text-slate-200 shadow-none caret-sky-300 placeholder:text-slate-400 md:text-[11px] dark:bg-slate-900/80"
      />
