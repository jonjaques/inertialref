...
export function FlightStrip({ status }: { status: HarnessStatus | null }) {
  ...
  return (
    <div className="pointer-events-none absolute bottom-3 left-3 max-w-[calc(100vw-1.5rem)] rounded-lg border border-slate-700/60 bg-slate-950/75 px-3 py-2 font-mono text-xs text-slate-200 backdrop-blur">
