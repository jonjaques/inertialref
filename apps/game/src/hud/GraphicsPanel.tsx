 ...
 *
 * One toggle today, but the panel exists for the shape of the problem: a
 * rendering feature under visual iteration needs an off switch, both to see
 * a before/after without reloading and to isolate an artifact to its source —
 * which is exactly how the lens flare's alpha-compositing bug was pinned to
 * the flare rather than the tone curve. Switches write plain engine fields;
 * the frame loop reads them, and nothing here re-renders per frame.
 */
