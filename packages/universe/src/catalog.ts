...
export const CATALOG: readonly CatalogStar[] = [
  { id: systemId('SOL'), name: 'Sol', rightAscension: 0, declination: 0, distanceLightYears: 0, spectralType: 'G2V', solarMasses: 1, components: 1 },
  { id: systemId('HIP70890'), name: 'Proxima Centauri', rightAscension: 217.4289, declination: -62.6795, distanceLightYears: 4.2465, spectralType: 'M5.5Ve', solarMasses: 0.122, components: 1 },
  { id: systemId('HIP71683'), name: 'Alpha Centauri', rightAscension: 219.9021, declination: -60.8340, distanceLightYears: 4.3650, spectralType: 'G2V', solarMasses: 1.079, components: 2 },
  { id: systemId('HIP87937'), name: "Barnard's Star", rightAscension: 269.4521, declination: 4.6933, distanceLightYears: 5.9629, spectralType: 'M4.0V', solarMasses: 0.144, components: 1 },
  { id: systemId('HIP54035'), name: 'Lalande 21185', rightAscension: 165.8341, declination: 35.9699, distanceLightYears: 8.3044, spectralType: 'M2.0V', solarMasses: 0.39, components: 1 },
  { id: systemId('HIP32349'), name: 'Sirius', rightAscension: 101.2871, declination: -16.7161, distanceLightYears: 8.6094, spectralType: 'A1V', solarMasses: 2.063, components: 2 },
  { id: systemId('HIP92403'), name: 'Ross 154', rightAscension: 282.4557, declination: -23.8362, distanceLightYears: 9.7035, spectralType: 'M3.5V', solarMasses: 0.17, components: 1 },
  { id: systemId('HIP16537'), name: 'Epsilon Eridani', rightAscension: 53.2327, declination: -9.4583, distanceLightYears: 10.4753, spectralType: 'K2V', solarMasses: 0.82, components: 1 },
  { id: systemId('HIP114046'), name: 'Lacaille 9352', rightAscension: 346.4667, declination: -35.8533, distanceLightYears: 10.7241, spectralType: 'M0.5V', solarMasses: 0.479, components: 1 },
  { id: systemId('HIP57548'), name: 'Ross 128', rightAscension: 176.9375, declination: 0.8043, distanceLightYears: 11.0074, spectralType: 'M4.0V', solarMasses: 0.168, components: 1 },
  { id: systemId('HIP104214'), name: '61 Cygni', rightAscension: 316.7247, declination: 38.7495, distanceLightYears: 11.4031, spectralType: 'K5V', solarMasses: 0.7, components: 2 },
  { id: systemId('HIP37279'), name: 'Procyon', rightAscension: 114.8255, declination: 5.2250, distanceLightYears: 11.4601, spectralType: 'F5IV-V', solarMasses: 1.499, components: 2 },
  { id: systemId('HIP8102'), name: 'Tau Ceti', rightAscension: 26.0170, declination: -15.9375, distanceLightYears: 11.9124, spectralType: 'G8.5V', solarMasses: 0.783, components: 1 },
  { id: systemId('HIP19849'), name: '40 Eridani', rightAscension: 63.8180, declination: -7.6528, distanceLightYears: 16.3355, spectralType: 'K0.5V', solarMasses: 0.84, components: 3 },
  { id: systemId('HIP97649'), name: 'Altair', rightAscension: 297.6958, declination: 8.8683, distanceLightYears: 16.7300, spectralType: 'A7Vn', solarMasses: 1.79, components: 1 },
  { id: systemId('HIP91262'), name: 'Vega', rightAscension: 279.2347, declination: 38.7837, distanceLightYears: 25.0400, spectralType: 'A0Va', solarMasses: 2.135, components: 1 },
  { id: systemId('HIP113368'), name: 'Fomalhaut', rightAscension: 344.4127, declination: -29.6222, distanceLightYears: 25.1300, spectralType: 'A3Va', solarMasses: 1.92, components: 3 },
  { id: systemId('HIP37826'), name: 'Pollux', rightAscension: 116.3290, declination: 28.0262, distanceLightYears: 33.7800, spectralType: 'K0III', solarMasses: 1.91, components: 1 },
]
...
export function equatorialToGalactic(
  ...
  const sinB =
    Math.sin(dec) * Math.sin(NGP_DEC) + Math.cos(dec) * Math.cos(NGP_DEC) * Math.cos(ra - NGP_RA)
...
export function catalogStarPosition(star: CatalogStar): UniverseVector {
  ...
  const galactocentric = vec3(hx - SUN_GALACTOCENTRIC_RADIUS, hy, hz + SUN_HEIGHT_ABOVE_PLANE)
