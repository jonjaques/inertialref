...
| River _networks_, flora            | The valleys are the zero-level strip of a noise and do not know which way is downhill; a network that drains needs a per-region drainage graph (Génevaux-style). Flora as geometry needs authored parts; the biosphere's pigment is in the cover already | § 5                                                                                                                                                                                                           |
