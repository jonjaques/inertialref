...
| M2        | The stellar field has a measurable shape from outside.             | M1                | Open in [PR #63](https://github.com/jonjaques/inertialref/pull/63) on `codex/galaxy-the-stellar-field`, based on PR #62 at `76cef98`. `galaxy-field@1`; 0.1 star/pc³ at the Sun; 116.185 billion stars in the reference cylinder; six tangencies within 3°. CPU plates and report through `pnpm sim --galaxy-plates .scratch/galaxy-m2/plates --galaxy-width 384`. Verified commit `3936e35`: `pnpm check` green, 118 files and 1,704 regular tests, four slow tests, docs and production builds; `pnpm sim --self-test` 12/12. Targets PR #62’s branch. |
