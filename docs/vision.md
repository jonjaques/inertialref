...
| 10  | Run a meaningful procedural task in a worker                   | 4,761 elevations + 33,800 cover bytes, identical |
| 11  | Serialize and restore world/player state                       | 1,041-byte fixture → identical state hash        |
