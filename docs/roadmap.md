...
| The canonical crater ladder stops at eleven | A body whose largest basin is 2,170 km has craters down to 2.1 km and then nothing until the presentational tail starts at 8 m                                | `MAX_CRATER_LEVELS`; fourteen moves the detail floor 0–2 levels at 13% a patch, and it is terrain algorithm v4                                                    |
