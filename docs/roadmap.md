...
| Structures, settlements  | 🟡     | Durable body-fixed placements and the Mars landing pad exist, including flat support disks for contact. Settlements, walls, and interiors remain unbuilt. [ADR-0040](adr/0040-structures-keep-a-body-fixed-anchor.md)                                                                              |
...
exploration is 🟡. A character can traverse terrain and flat support disks,
...
| Terrain and support-disk contact only         | Character stepping, uphill slope limits, and local-gravity jumps exist. Rocks, hull walls, ceilings, arbitrary meshes, and entity-to-entity contact do not.                                                                                                                        |
