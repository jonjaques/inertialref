...
| ---------------------- | ------ | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Galaxy, systems, stars | ✅     | Catalog + procedural fill            | 7,123 real systems within 150 ly and the 7,515 naked-eye stars beyond, from the [ingest pipeline](galaxy.md#ingest-pipeline)                                                                                                              |
