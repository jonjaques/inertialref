...
| **Enhanced**              | The default camera direction: an HDR composite that shows bright worlds and faint space together. The three camera modes are implemented; [ADR-0037](../adr/0037-the-enhanced-camera.md) owns their policy. |
