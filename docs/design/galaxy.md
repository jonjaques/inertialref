...
`packages/universe/src/catalog/identity.ts`, resolves 99.3% of systems to an id
no rebuild can move, and has golden vectors covering every rung of the ladder.
...
in `manifest.json`. Nothing yet compares two of them.
