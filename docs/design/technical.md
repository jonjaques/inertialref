...
| Terrain reconciliation    | 1.0 ms | Selection 0.11–0.31 ms, mesh build 0.25 ms a patch at four a frame; generation is off-thread. Measured 2026-08-27: the whole frame is **2.04 ms at 63.9 fps** standing on Miranda's summit, 438 patches and 3.59 M triangles selected |
