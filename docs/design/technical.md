...
| Terrain patch generation                       | ≤ 8 ms per patch per worker           | **12.7–13.5 ms**, 0.32 M samples/s — measured 2026-08-26 on an M5, Node 26, main thread, 48 patches after warm-up. **Over budget by 60%**, before any geology    |
