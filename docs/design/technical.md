...
| Area           | Work                                                                                                                                | Seam                                                                                                                                                                                                                                                                                                               |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Terrain**    | An orbital albedo bake, authored material sets, scatter                                                                             | Quadtree LOD, geomorphing and cross-face sampling landed with [ADR-0015](../adr/0015-terrain-level-of-detail.md); the geology with [ADR-0019](../adr/0019-the-geology.md) and the material with [ADR-0020](../adr/0020-the-face.md) — the detail field in `render/terrain.ts` is where hex-tiling and triplanar go |
