...
trading. That is not a niche within the audience; for this design it _is_ the
audience.
...
_The single hardest milestone, and the one that determines whether any of this
looks like anything._

|                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Delivers**   | Terrain that holds up from orbit to underfoot, in a WebGPU renderer with physically-correct lighting                                                                                                                                                                                                                                                                                                                                                                      |
| **Scope**      | Quadtree terrain LOD · geomorphing · edge stitching · cube-face wrapping · 8 biomes with PBR material sets · rock scatter · WebGPU migration · **HDR output to extended-range displays** · multiple-scattering atmosphere · Enhanced composition plus Automatic and Manual photographic exposure across the scene’s brightness range · LOD hysteresis and cross-fade · sphere-derived impostors · predictive streaming with a generation budget · **a benchmark harness** |
...
| **Estimate**   | `[Assumption: 4–7 months at this team size. Original scope estimate; remaining work needs a separate estimate.]`                                                                                                                                                                                                                                                                                                                                                          |

**Implemented foundations:** WebGPU/TSL, restricted morphing terrain,
cross-face coverage, predictive terrain streaming, rock scatter, extended-range
output, the sensor chain and its three camera modes, profiling tools, and the
calibrated galaxy sky. Their measurements and limits are in
[technical](technical.md), [ADR-0037](../adr/0037-the-enhanced-camera.md) and
[ADR-0038](../adr/0038-the-stars-and-the-diffuse-sky.md).

**The M2 gate remains a target.** Authored biome material sets, erosion, a
walking player with rock interaction, and demonstrated 60 fps on the target
laptop are not established by those implementations. The estimate above is the
original scope estimate, not a fresh forecast for the remaining work.
...
_The ship becomes a machine you operate._
...
_The loop closes and the game becomes releasable._

|                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Delivers**   | The galaxy, the maps, the reward model, and a reason to keep playing                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Scope**      | [Catalog ingest pipeline](galaxy.md#ingest-pipeline) with HYG + NASA Exoplanet Archive · catalog versioning in the generation manifest · **issue-ordinal addressing** ([ADR-0009](../adr/0009-issue-ordinal-addressing.md), implemented) · body manifests with tombstones · [galaxy map](galaxy.md#the-galaxy-map) with three scale tiers and the horizon of knowledge · [system map](galaxy.md#the-system-map) · route planning, both routes · [scan ladder](exploration.md#the-scan-ladder) tiers 1–3 · the Almanac · discovery credit · the data economy and unlock curve · [solo online](modes.md#solo-online) sync · [offline preparation](modes.md#solo-offline) · the [FTUE](ux.md#first-time-experience) · accessibility |
| **Depends on** | M3 for a ship worth flying                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Gate**       | A new player reaches the [28-minute mark](ux.md#first-time-experience) — standing on the Moon, looking up at Earth — with no tutorial and no assistance. A 10-hour session produces a filled Almanac and a fitted ship. A simulated catalog revision produces a correct notice, retains discovery credit, and does not invalidate a single save.                                                                                                                                                                                                                                                                                                                                                                                 |
| **Estimate**   | `[Assumption: 4–6 months. Cross-catalog identity resolution is the item most likely to be underestimated — see galaxy.md.]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |

Catalog ingest, version reporting, issue ordinals and predicate world search
are implemented. Discovery credit, the Almanac reward loop, online sync and
this milestone's player acceptance gate remain future work.
...
| **Scope**    | Input log and replay recording _(prerequisite)_ · `AuthorityPort` with a local implementation · entity replication · client prediction and reconciliation · interest management · partition handoff · mutation conflict resolution · net protocol versioning · opt-in PvP · moderation and naming policy |
...
without anyone authoring content.** A [catalog revision](galaxy.md#catalog-revisions)
is new content generated by the astronomy community, and the pipeline that
delivers it is built once.

| Cadence                   | Item                                                                             |
| ------------------------- | -------------------------------------------------------------------------------- |
| Per major catalog release | A Revision — new confirmed bodies, refined orbits, expanded horizon of knowledge |
...
| -------------------------------------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **WebGPU migration**                         | M2        | Implemented; maintaining WebGPU and WebGL parity remains an acceptance cost                                                                                                      |
...
| **Benchmark harness**                        | M2        | Implemented; target-hardware acceptance and a controlled regression gate remain                                                                                                  |
| **Parts-assembly for hulls and interiors**   | M3        | The whole content strategy rests on it and it has never been built                                                                                                               |
| **Cross-catalog identity resolution**        | M4        | Silent corruption here poisons addressing, saves and discovery records simultaneously                                                                                            |
| **Issue-ordinal addressing**                 | M4        | A change to the addressing model that touches saves. [ADR-0009](../adr/0009-issue-ordinal-addressing.md) implemented; catalog-revision and discovery-retention acceptance remain |
