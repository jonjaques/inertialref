...
**Adaptive triggers** are on *state*, not on timers: entering an atmosphere,
...
*Reference:* the ambient work in *Elite Dangerous* (Erasmus Talbot) for the
in-space register, and *Outer Wilds* for the discipline of using very little.
**Not** *No Man's Sky* — 65daysofstatic's score is excellent and it is
...
| **Physical objects have mass in the mix** | A sample core set down sounds heavy; in low gravity it sounds heavy and *slow* |
