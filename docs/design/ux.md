...
which stopping the world is correct — the save captures canonical state and restores an
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Motion sickness** | A lens the player sets — 8.4 to 68 mm on a 24 mm gauge, which is 110° to 20° ([ADR-0017](../adr/0017-the-lens.md)); head-bob off by default; roll-compensation option that keeps the horizon level; a "reduce camera shake" toggle that affects all shake. **The flip is the highest-risk moment in the game** — a 180° rotation under freefall — so it gets its own option: assist-flip, which is slower and smoother, and a fixed-horizon option through the rotation. |
