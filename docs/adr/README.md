...
| [0044](0044-the-sensor-reconstructs-the-display.md)     | The reconstructed display     | accepted; image and performance acceptance pending       | One picture record combines edges and render scale; the sensor runs FSR before display-size optics, with reversed floating-point WebGPU depth, declared history cuts and a logarithmic WebGL fallback.                                                                                                                                                                                                                                                                                                                                                                                                                  |
