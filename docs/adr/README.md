...
Thirty-four decisions that are expensive to reverse. Each records the **context**, the
...
| [0031](0031-the-sensor-response.md)                 | The sensor response         | accepted     | One lens-driven chain owns exposure, glare, defocus, motion and detector response; Natural preserves the production ACES fit and integrated sky, physical responses are explicit camera choices, and P3 requires matching canvas and encoder declarations.                                                                                                                                                                                                                                                                                                                                                              |
