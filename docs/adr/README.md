...
| [0031](0031-the-sensor-response.md)                 | The sensor response         | accepted           | One lens-driven chain owns exposure, glare, defocus, motion and detector response; its Natural baseline is partly superseded by ADR-0037’s accepted three-mode direction, and P3 requires matching canvas and encoder declarations.                                                                                                                                                                                                                                                                                                                                                                                     |
...
| [0037](0037-the-enhanced-camera.md)                 | The Enhanced camera         | accepted direction | Enhanced composes the default bright-world and faint-sky image; Automatic and Manual share photographic exposure. Implementation is planned; display output remains independent.                                                                                                                                                                                                                                                                                                                                                                                                                                        |
