...
| [0037](0037-the-enhanced-camera.md)                 | The Enhanced camera         | implemented; image review pending | Enhanced composes the default bright-world and faint-sky image; Automatic and Manual share photographic processing. Policy, compatibility and rendering are implemented; matched images and transitions await preview review. Display output remains independent.                                                                                                                                                                                                                                                                                                                                                       |
