...
The canonical imperatives live in [`AGENTS.md`](../../AGENTS.md). This page maps
each one to its technical home and carries the full constraints, exceptions,
and reasoning below. Read the relevant rule in full before changing its area;
the short imperative is an index, not a substitute for those constraints.
...
| The star catalog is an argument, not a singleton                                              | [Galaxy](../design/galaxy.md) · [Catalog](../guides/catalog.md)                                                        |
| Do not store what the catalog can derive                                                      | [Catalog](../guides/catalog.md)                                                                                        |
| A survey is not a search box                                                                  | [Catalog](../guides/catalog.md)                                                                                        |
...
cannot see it. [ADR-0022](../adr/0022-the-timeline.md).
...
[ADR-0027](../adr/0027-the-rings.md).
...
[ADR-0019](../adr/0019-the-geology.md).
...
on the next tick. [ADR-0025](../adr/0025-the-rails.md).
...
astronomy publishes. [Galaxy, rule 1](../design/galaxy.md).
...
[ADR-0009](../adr/0009-issue-ordinal-addressing.md).
...
[ADR-0003](../adr/0003-render-coordinates.md).
...
reads like a factor. [ADR-0015](../adr/0015-terrain-level-of-detail.md).
...
[ADR-0006](../adr/0006-simulation-clock.md).
...
[ADR-0016](../adr/0016-documentation-as-a-mode.md).
...
everywhere else. [Cinematics](../guides/cinematics.md).
...
[Cinematics](../guides/cinematics.md).
