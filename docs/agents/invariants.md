...
| A stand-in `DataTexture` is filtered like its map                                             | [Testing](../guides/testing.md#shader-behavior-runs-on-the-real-gpu-from-node) · [Rendering](../concepts/rendering.md) |
